const { 
    joinUser, getCurrentUser, leaveUser, getUsersInRoom 
...
test('getUsersInRoom should return all users in a room', () => {
    ...
    expect(usersInRoom).toContainEqual({ id: 1, username: 'Joshua', room: 'Room 1' });
    expect(usersInRoom).toContainEqual({ id: 2, username: 'Nachi', room: 'Room 1' });
    expect(usersInRoom).toContainEqual({ id: 4, username: 'Hali', room: 'Room 1' });
    expect(usersInRoom).not.toContainEqual({ id: 3, username: 'Leo', room: 'Room 2' });
  });